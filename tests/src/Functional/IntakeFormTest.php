...
class IntakeFormTest extends RcdTestBase {
  ...
  protected function fieldData($step = NULL) {
    $field_data = [
      ...
      2 => [
        ...
        'property[land_use][land_use][rangeland]' => TRUE,
        'property[land_use][land_use][pasture]' => TRUE,
        ...
        'property[land_use][land_use][forestry]' => TRUE,
        'property[land_use][land_use][natural]' => TRUE,
        'property[land_use][land_use][other]' => TRUE,
        'property[land_use][rangeland_acreage]' => 10,
  ...
  public function testIntakeForm() {
    ...
    $expected = [
      ...
      'intake_property_use_rangeland_ac' => $field_data[2]['property[land_use][rangeland_acreage]'],
      'intake_property_use_pasture_ac' => $field_data[2]['property[land_use][pasture_acreage]'],
      ...
      'intake_property_use_forestry_ac' => $field_data[2]['property[land_use][forestry_acreage]'],
